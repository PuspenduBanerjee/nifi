...
//        authorizeController(RequestAction.READ);
    ...
    public Response sideLoad(@Context HttpServletRequest httpServletRequest,
            ...
            @ApiParam(value = "GroupId") @QueryParam("narURI") String groupId,
            @ApiParam(value = "ArtifactId") @QueryParam("narURI") String artifactId,
            @ApiParam(value = "Version") @QueryParam("narURI") String version) {
